var dictionary = {
  ...
  'en':{  
   ...
   'contents': `Worked as an architect restorer, planner, and cultural heritage expert with Riwaq, Center for Engineering and Planning, and other local and private institutions. 
    ...
    in Architecture from Birzeit University and her Master in Architecture from Miami University.`
	  ...
	  'ar':{
	   'title': 'اﻟﻌﺮﺑﻴﺔ',
	   'contents': `ساقية هي أكاديميَّة تقدميَّة؛ حقل لإنتاج المعرفة التجريبيَّة والتشارك، تٌطعِّم التقاليد الزراعية المحليَّة للاكتفاء الذاتي بالفنون المعاصرة والممارسات البيئيَّة. يدمج نموذج ساقية المستدام الزراعة بإطار برنامج إقامات متعدد التخصصات، حيث يتولى الفاعلون/ات الثقافيون/ات، مثل المزارعين/ات ومبادرات الحرف اليدوية/ الصناعات الصغيرة، دوراً بارزاً إلى جانب الفنانين/ات والباحثين/ات المحليين/ات والزائرين/ات، متحدّين بذلك الفجوة الديموغرافيَّة التي تميّز الإنتاج والاستهلاك الثقافيّ في فلسطين.
         <div class="textImage"></div>
		رؤية ساقية: "التحرّر عبر مجتمع تتجذَّر ثقته في الممارسات البيئيَّة التقليديَّة والمعاصرة، ويحاكي تسامحه تنوّع الطبيعة، وينبع كرمه من العمل الجماعيّ، ويُثرى إبداعه بالتقاطع بين الفنون، والعلوم، والزراعة، ويتم مشاركة ازدهاره عبر الحدود."`
	  },
    'img': [
      {
        'caption-en': 'hanging out',
        'caption-ar': 'اﻟﻌﺮﺑﻴﺔ',
 ...
 "NidaSinnokrotPage": {
  ...
  'en':{  
   ...
   'contents': `As an artist, much of Nida Sinnokrot’s work aims to subvert various technologies of control that give rise to shifting social, political and geographic instabilities. Nida Sinnokrot received his BA from the University of Texas at Austin and an MFA from Bard College. 
    In 2001 he participated the Independent Study Program of the Whitney Museum of American Art. Nida Sinnokrot is a 2002 Rockefeller Foundation Media Arts Fellow. His work has received support from Darat al Funun, Akademie Schloss Solitude, the Merz Akademie, 
    the Sharjah Biennial, and the Al Mamal arts centre. His works featured in exhibitions including the Sharjah Biennial (2017 and 2009), Taipei Biennial (2016), Tea with Nefertiti (2012/14), and Biennial Cuvée – World Selection of Contemporary Art (2010). 
    Nida’s work is in various collections including the Sharjah Art Foundation and the Khalid Shoman Foundation. Nida lives and works in Jerusalem and Boston and teaches in the Art Culture and Technology (ACT) program at the Massachusetts Institute of Technology (MIT). 
   `},
  'ar':{
   'title': 'اﻟﻌﺮﺑﻴﺔ',
   'contents': `ساقية هي أكاديميَّة تقدميَّة؛ حقل لإنتاج المعرفة التجريبيَّة والتشارك، تٌطعِّم التقاليد الزراعية المحليَّة للاكتفاء الذاتي بالفنون المعاصرة والممارسات البيئيَّة. يدمج نموذج ساقية المستدام الزراعة بإطار برنامج إقامات متعدد التخصصات، حيث يتولى الفاعلون/ات الثقافيون/ات، مثل المزارعين/ات ومبادرات الحرف اليدوية/ الصناعات الصغيرة، دوراً بارزاً إلى جانب الفنانين/ات والباحثين/ات المحليين/ات والزائرين/ات، متحدّين بذلك الفجوة الديموغرافيَّة التي تميّز الإنتاج والاستهلاك الثقافيّ في فلسطين.
